...
// new_list
// old_list
// copy from Nodes_List to old_list
// free(Nodes_list)
// Nodes_list = new_list
//for i from 0 to old_cap:
// hash to Nodes_list
// free(old_list)
/**
 ...
 * The minimal load factor of the hash set
 * (if it reaches this value the hashtable should be shrinked).
 * Example: if the hash_set capacity is 16,
 * and it has 5 elements in it (size is 5),
 * if an element is erased, the load factor drops to 0.25,
 ...
 * The maximal load factor of the hash set.
 * (if it reaches this value the hashtable should be made bigger).
 * Example: if the hash_set capacity is 16,
 * and it has 11 elements in it (size is 11),
 * if another element is added, the load factor goes to 0.75,
